...
<html lang="zh-CN">
  ...
  <jsp:include page="../public/top.jsp"></jsp:include>
     ...
     <!-- Page Container -->
        <div class="page-container">
          ...
          <form class="form" action="#">
            <div class="form-title">Edit Plan</div>
           ...
           <div class="row">
            ...
            <div class="form-group">
             <label style="font-weight:normal;font-size: 15px;line-height:2.3">View</label>
              ...
              <button id="save_plan" class="btn btn-default" type="button">Save</button>
    ...
    <script src="../../assets/js/datetime/daterangepicker.js"></script>
     ...
     <script type="text/javascript" src="../../js/cdp/way/plan_edit.js"></script>
  </body>
