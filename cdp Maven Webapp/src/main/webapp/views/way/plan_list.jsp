  ...
  <jsp:include page="../public/top.jsp"></jsp:include>
    ...
    <div class="main-container container-fluid">
     <!-- Page Container -->
            ...
            <div class="page-content">
                ...
                <div id="note_list_div">
                	...
                	<div class="col-lg-9 col-sm-9 col-xs-9">
                		<a class="btn btn-default purple" id="new_note" href="plan_add.jsp?m=2-4"><i class="fa fa-plus"></i> Add</a>
                	</div>
                	<div class="col-lg-3 col-sm-3 col-xs-3">
                		<div class="input-group">
                              <span class="input-group-addon">
                              <i class="fa fa-calendar"></i>
                              </span><input type="text" name="plan_starttime" class="form-control" id="reservation">
                        </div>
                	</div>
                	</div>
					...
					<div class="row">
                		<table id="plan_list" class="table table-hover">
          	    <thead><tr>
          	    <th class="header">Title</th>
          	    <th class="header">Create Date</th>
          	    <th class="header">Run Date</th>
   	...
   	<input id="share_plan_id" name="share_plan_id" type="hidden">
    ...
    <script src="../../assets/js/datetime/daterangepicker.js"></script>
     ...
     <script type="text/javascript" src="../../js/cdp/way/plan_list.js"></script>
  </body>
