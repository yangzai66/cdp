...
var edit_note = function(id){
	Public.ajaxGet("/note/view/"+id, {
		...
		if(msg.result){
			...
			$("#note_edit_content").summernote('code',msg.data.NOTE_CONTENT);
			$("#note_edit_id").val(id);
...
//        			var params = new Map();
        			...
        			var note_content = $("#note_content").summernote('code');
...
//    	    		params.put("NOTE_TYPE", $("select[name='add_note_type']").val());
        		...
        		$("#note_edit_btn").click(function(){
    	    		...
    	    		params.put("NOTE_CONTENT",$("#note_edit_content").summernote('code'));
