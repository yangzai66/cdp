...
<div class="container" style="width:100%;margin-top:80px;">
	...
	<div class="col-sm-6 col-md-2">
        ...
        <tr>
         ...
         <th class="header headerSortUp" data-sort="UPS_DOWNS_RATE">涨幅</th>
         <th class="header" data-sort="UPS_DOWNS_PRICE">涨幅价</th>
         <th class="header" data-sort="CUR_PRICE">价格</th>
         <th class="header" data-sort="HIGH_PRICE">最高</th>
         <th class="header" data-sort="LOW_PRICE">最低</th>
         <th class="header" data-sort="FUND_MAIN_PURE">净流入</th>
        </tr>
      </thead>
      <tbody>
      </tbody>
    ...
    <script src="../../js/messenger/messenger.min.js"></script>
     <script src="../../js/cdp/stock/custom.js"></script>
  </body>
</html>