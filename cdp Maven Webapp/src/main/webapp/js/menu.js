  		...
  		$.getJSON("/cdp/menu/list",function(msg){
	  		...
	  		if(jQuery.isEmptyObject(model.child)){
	  			...
	  			if(m_a==i){
	  				...
	  				menu_text+="<li class=\"active open\"><a href=\"#\" class=\"menu-dropdown\"><i class='"+model.css+"'></i><span class=\"menu-text\"> "+model.name+" </span> <i class=\"menu-expand\"></i></a><ul class=\"submenu\">";
	  			}else{
	  				menu_text+="<li><a href=\"#\" class=\"menu-dropdown\"><i class='"+model.css+"'></i><span class=\"menu-text\"> "+model.name+" </span> <i class=\"menu-expand\"></i></a><ul class=\"submenu\">";
	  			}
	  				...
	  				if(jQuery.isEmptyObject(m2.child)){
	  					...
	  					if(m_b==k){
	  						...
	  						if(m_c==0){
	  		  				...
	  		  				menu_text+="<li class=\"active open\" ><a href=\"#\" class=\"menu-dropdown\"><i class='"+m2.css+"'></i><span class=\"menu-text\"> "+m2.name+" </span> <i class=\"menu-expand\"></i></a><ul class=\"submenu\">";
	  		  			}else{
	  		  				menu_text+="<li><a href=\"#\" class=\"menu-dropdown\"><i class='"+m2.css+"'></i><span class=\"menu-text\"> "+m2.name+" </span> <i class=\"menu-expand\"></i></a><ul class=\"submenu\">";
	  		  			}
